...
@Autowired
public ${className_d}Repository(${className_d}Mapper ${className_x}Mapper1) {
...
int num = this.${className_x}Mapper.insertSelective(${className_x});
if(num>0){
...
int num = this.${className_x}Mapper.updateByPrimaryKeySelective(${className_x});
if(num>0){
//this.${className_x}Cache.save(${className_x});
}
return num>0;
...
int num = this.${className_x}Mapper.deleteByPrimaryKey(${className_x}.getId());
if(num>0){
...
int num =  this.${className_x}Mapper.logicDelete(id);
if(num>0){
...
*/
@Override
public List<${className_d}> findByIdList(List
<String> idList) {
...
${className_d} ${className_x}){
    ...
    */
    @Override
    public ${className_d} getBy${className_d}Id(Long id){
    //${className_d} ${className_x} = this.${className_x}Cache.getById(id);
    //if(${className_x}==null){
${className_d} ${className_x} = this.${className_x}Mapper.getBy${className_d}Id(id);
    if(${className_x}!=null){
    //this.${className_x}Cache.save(${className_x});
    }
    //}
